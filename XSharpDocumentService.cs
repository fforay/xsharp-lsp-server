...
namespace XSharpLanguageServer
{
    ...
    public sealed class XSharpDocumentService
    {
        ...
        private sealed class ErrorListener : VsParser.IErrorListener
        {
            ...
            /// </summary>
            /// <remarks>
            /// <see cref="LinePositionSpan"/> only carries a start position (line + column),
            /// not an end position. We extend the range by one character as a fallback so
            /// the squiggle is always visible. Future work could widen the range using the
            /// token length from the token stream.
            /// </remarks>
                ...
                DiagnosticSeverity severity)
            {
                ...
                return new Diagnostic
                {
                    ...
                    Source = "xsharp",        // identifies this server in the Problems panel
